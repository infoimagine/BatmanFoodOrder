    ...
    private void listeners() {
        addCardButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardDetailActivity.this, CardEditActivity.class);
    ...
    private void addCardListener(final int index, CreditCardView creditCardView) {
        creditCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CardDetailActivity.this, "Card Number :"+cardNumber, Toast.LENGTH_SHORT).show();
